...
# write results
out <- here("data","GOBP","AM-CCL",compare,"GO_BP")
if (!dir.exists(out)) {
  dir.create(here("data","GOBP","AM-CCL",compare,"GO_BP"))
}
...
# DotPlot of TRM-CCL
genes <- c("FN1","EREG","CCL4","CXCL2","CXCL3","CXCL8","TNFAIP3","TNFAIP6","IER2",
           "NAMPT","EGR1","ZFP36","GADD45B","FOS","FOSB","JUNB","NFKBIA","NFKBIZ","DUSP1")
...
# AM-CCL dotplot
pt1
ggsave(last_plot(),filename=here("data","plots","AM-CCL","overlap.dotplot.jpeg"),
