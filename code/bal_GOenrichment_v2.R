...
# ETI
celltypes <- setNames(c("ETI.TRM-CCL","ETI.RecM"),
                      c("ETI.TRM-CCL", "ETI.RecM"))
...
write.csv(bigdf, file=here("data","GOBP","ETI.bigdf_v2.csv"), row.names = FALSE)
