...
ggsave(plot=p,
       device="jpeg",
       dpi=1600,
       filename = here("data","plots","TRM-CCL",paste0("bal_ETI.",celltype,".MDSplot.jpeg")),
       height=6,
       width=6)
...
ggsave(plot=p2,
       device="jpeg",
       dpi=1600,
       filename = here("data","plots","TRM-CCL",paste0("bal_ETI.",celltype,".MDSplot2.jpeg")),
       height=6,
       width=8)
