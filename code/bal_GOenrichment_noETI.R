...
# ETI
celltypes <- setNames(c("Epithelial","TRM-CCL"),
                      c("Epithelial","TRM-CCL"))
...
compare.list <- setNames(c("CFN vs HC",
                           "CFB vs HC",
                           "CFB vs CFN"),
                         c("CFN_vs_HC",
                           "CFB_vs_HC",
...
write.csv(bigdf, file=here("data","GOBP","noETI.bigdf_mast.csv"), row.names = FALSE)
