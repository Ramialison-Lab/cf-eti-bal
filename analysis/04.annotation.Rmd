...
ggsave(plot=last_plot(),
       device="jpeg",
       dpi=1600,
       filename = here("data","plots","combined",paste0(celltype,".smallumap.jpeg")),
       height=3,
       width=3,
       bg = "transparent")
...
ggsave(plot=last_plot(),
       device="jpeg",
       dpi=1600,
       filename = here("data","plots",celltype,"bal_combined_nosplit.umap.jpeg"),
       height=4,
       width=5)
...
ggsave(plot=last_plot(),
       device="jpeg",
       dpi=1600,
       filename = here("data","plots",celltype,"ProlifM.smallumap.jpeg"),
       height=3,
       width=3,
       bg = "transparent")
